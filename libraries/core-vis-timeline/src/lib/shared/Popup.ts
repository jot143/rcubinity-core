...
class Popup {
   ...
   */
  constructor(container: any, overflowMethod: any) {
  ...
  show(doShow: any) {
    ...
    if (doShow === true) {
      ...
      var maxHeight = (this.frame.parentNode as any)?.clientHeight;
      var maxWidth = (this.frame.parentNode as any)?.clientWidth;
   ...
   */
  destroy() {
    (this.frame.parentNode as any).removeChild(this.frame); // Remove element from DOM
  }
}
