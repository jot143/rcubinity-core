 ...
 * @constructor Points
 */
function Points(groupId: any, options: any) {  // eslint-disable-line no-unused-vars
}
 ...
 * @param {number} [offset]
 */
Points.draw = function (dataset: any, group: any, framework: any, offset: any) {
  offset = offset || 0;
...
Points.drawIcon = function (group: any, x: any, y: any, iconWidth: any, iconHeight: any, framework: any) {
 ...
 */
function getGroupTemplate(group: any, callbackResult: any = undefined) {
 ...
 * @returns {function}
 */
function getCallback(framework: any, group: any) {
