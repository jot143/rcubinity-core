...
class PointItem extends Item {
  props: { dot: { top: number; width: number; height: number; }; content: { height: number; marginLeft: number; marginRight: number; }; };
  cluster: any;
  /**
 ...
 */
  ...
  pointX(point: any, pointX: any, pointY: any, rtl: any) {
    throw new Error('Method not implemented.');
  }
  pointY(point: any, pointX: any, pointY: any, rtl: any) {
    throw new Error('Method not implemented.');
  }
